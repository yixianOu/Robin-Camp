...
type Bootstrap struct {
	...
	Boxoffice     *BoxOffice             `protobuf:"bytes,3,opt,name=boxoffice,proto3" json:"boxoffice,omitempty"`
...
func (x *Bootstrap) GetBoxoffice() *BoxOffice {
	if x != nil {
		return x.Boxoffice
	}
	return nil
...
func (x *BoxOffice) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *BoxOffice) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
func (x *BoxOffice) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *BoxOffice) GetMaxRetries() int32 {
	if x != nil {
		return x.MaxRetries
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\tboxoffice\x18\x03 \x01(\v2\x15.kratos.api.BoxOfficeR\tboxoffice\x12$\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x8c\x01\n" +
	"\tBoxOffice\x12\x10\n" +
	...
	"maxRetries\"\x1c\n" +
	"\x04Auth\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05tokenB\x18Z\x16src/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*BoxOffice)(nil),           // 3: kratos.api.BoxOffice
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.boxoffice:type_name -> kratos.api.BoxOffice
	...
	9,  // 8: kratos.api.BoxOffice.timeout:type_name -> google.protobuf.Duration
